...
// IMPORTANT — this is the rootDir for THIS directory only. Requires refactoring to be used in a package/CLI
...
const typesTemplate = `export const iconValues = new Set(${JSON.stringify(rawSvgData.filenames)}) 
export type IconIds = '${rawSvgData.filenames.join("' | '")}'`
